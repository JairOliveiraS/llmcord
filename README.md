...
| **max_history_images** | The maximum number of images included from channel history per reply, newest messages first. Older images (and expired attachment links, which are skipped automatically) are dropped when exceeded.<br /><br />Default: `10`<br /><br />**Set to `0` to disable history images entirely.**<br /><br />**Only applicable when using a vision model.** |
| **max_messages** | The maximum number of recent channel messages used as conversation context. When exceeded, the oldest messages are dropped.<br /><br />Default: `25` |
